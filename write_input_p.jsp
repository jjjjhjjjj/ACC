...
<%
String realFolder = "";
String savePath ="D:/soo/soo/WebContent/img2/";  //파일저장할 곳
...
String strSQL = "SELECT Max(num) FROM tblboardimg";
...
strSQL ="INSERT INTO tblboardimg (num, name, pass, email, title, contents, writedate, readcount, filename)";
...
response.sendRedirect("listboard_p.jsp"); 
%>
