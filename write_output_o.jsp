...
.main .review_img {
	...
	height: 112px;
	width: 1200px;
	background-image: url(img/modify_img.png);
}
.main .review_table {
	height: auto;
	width: 900px;
...
<TABLE border='0' width='600'>
	<TR>
		<TD align='left'>
			<a href="modify_input_o.jsp?num=<%=num %>">[수정하기]</a>
			<a href="delete_input_o.jsp?num=<%=num %>">[삭제하기]</a>
		</TD>

		<TD align='right'>
			<a href='write_o.jsp'>[사진등록]</a>
			<a href='product_master.jsp'>[상품페이지]</a>
 		</TD>
	</TR>
</TABLE>
