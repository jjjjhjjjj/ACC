...
try {
	...
	String strSQL = "SELECT * FROM tblZipCode where d like '%" + fdong + "%'";
...
<%
	...
	while(rs.next()) {
		...
		String code = rs.getString("a");
		String sido = rs.getString("b");
		String gungu = rs.getString("c");
		String dong = rs.getString("d");
		String bungi = rs.getString("e");
